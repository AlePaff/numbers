      ...
      <div className="sm:container mx-2">
        <div className="flex justify-center">
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="w-11 h-6 peer-focus:outline-none peer-focus:ring-2 rounded-full peer
            peer-checked:after:translate-x-full after:absolute after:top-[2px] after:left-[2px]
            after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-arena-6 after:bg-white
            after:border-gray-300 after:border peer-checked:after:border-white bg-arena-4 peer-focus:ring-arena-5 "></div>
